...
if ((iloscPortali % 2) == 1) { // jeśli nieparzysty portal (rozmieszczany
// w pionie)
...
//System.out.print(" sprawdzamy " + połozenie);
...
x++;
// System.out.print(" wspó	rzędne "+x+" = "+zajetePola.get(x-1));
}
// System.out.println("\n");
return zajetePola;
}
